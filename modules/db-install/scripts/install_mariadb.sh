...
DB_NAME="example_db"
username="administratos" # Bytt til et passende brukernavn (Se README)
password="Password123!" # Bytt til et passende passord (Se README)
...
# Insert sample data
sudo mysql -e "USE ${DB_NAME}; INSERT INTO employees (name, position, salary) VALUES ('Alice', 'Developer', 70000), ('Bob', 'Designer', 65000), ('Charlie', 'Analyst', 72000), ('Diana', 'CEO', 120000);"